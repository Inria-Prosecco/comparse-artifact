...
%splice [ps_iso_session_st_generic] (gen_parser (`iso_session_st_generic))
%splice [ps_iso_session_st_generic_is_well_formed] (gen_is_well_formed_lemma (`iso_session_st_generic))

instance session_st_parseable_serializeable: parseable_serializeable bytes session_st
 = mk_parseable_serializeable ps_iso_session_st_generic
