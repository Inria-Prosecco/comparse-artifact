...
noeq type iso_session_st_generic (bytes:Type0) {|bytes_like bytes|} =
  |InitiatorSentMsg1: b:principal -> x:bytes -> iso_session_st_generic bytes
  |ResponderSentMsg2: a:principal -> gx:bytes -> gy:bytes -> k:bytes -> iso_session_st_generic bytes
  |InitiatorSentMsg3: b:principal -> gx:bytes -> gy:bytes -> k:bytes -> iso_session_st_generic bytes
  |ResponderReceivedMsg3: a:principal -> gx:bytes -> gy:bytes -> k:bytes -> iso_session_st_generic bytes

type session_st = iso_session_st_generic bytes
